package com.aaratechnologies.testfilter;
            ...
            public void onCheckedChanged(RadioGroup group, int checkedId) {
                switch (checkedId) {
                    case R.id.sortByName:
                        Item[] itemsArr1 = new Item[items.size()];
                        itemsArr1 = items.toArray(itemsArr1);
                        Arrays.sort(itemsArr1, Item.nameComparator);
                    ...
                    case R.id.sortBySize:
                        ...
                        Arrays.sort(itemsArr2, Item.sizeComparator);
                    ...
                    case R.id.sortByPrice:
                        ...
                        Arrays.sort(itemsArr3, Item.priceComparator);
